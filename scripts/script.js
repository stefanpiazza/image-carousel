(function() {
    var carousel = {
        ...
        __initEvents: function() {
            ...
            carousel.wrapper.addEventListener('mousedown', this.startHandler.bind(this), false);
            carousel.wrapper.addEventListener('mousemove', this.moveHandler.bind(this), false);
            carousel.wrapper.addEventListener('mouseup', this.endHandler.bind(this), false);           
            carousel.wrapper.addEventListener('mouseleave', this.endHandler.bind(this), false);           
        ...
        startHandler: function(event) {
            carousel.startX = (event.touches ? event.touches[0].pageX : event.pageX);
        ...
        moveHandler: function(event) {
            if (carousel.isTouchStart && carousel.isMoving === false) {
                carousel.panelContainer.style.webkitTransitionDuration = '0';

                carousel.distanceX = (event.touches ? event.touches[0].pageX : event.pageX) - carousel.startX;
        ...
        endHandler: function(event) {
            ...
            if (Math.abs(carousel.distanceX) === 0) {
        ...
        handleTransitionEnd:function() {
            if (carousel.currentDistanceX === -(carousel.maxDistanceX - carousel.panelWidth)) {
                ...
                carousel.panelContainer.style.webkitTransitionDuration = '0ms';
